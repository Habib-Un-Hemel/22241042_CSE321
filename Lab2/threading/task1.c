...
// onlyprint in a pointer to a function that takes a void pointer and returns a void pointe || 
//it is needed becuase of the pthread_create function.
...
int main()
{
    ...
    for (i = 1; i < 6; i++)
    {
        ...
        // pthread_join is used to wait for the thread to terminate || passing NULL cause I don't need the return value of the thread.
